...
/**
 * The annotated element must be a number whose value must be lower or equal to the specified minimum.
 *
 * Supported types are:
 * <ul>
 * <li>BigDecimal</li>
...
@Documented
@Validator(name = "com.github.vincentrussell.validation.annotation.DecimalMin",
